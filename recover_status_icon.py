...
for line in reversed(lines):
    if "function updateStudentListStatusIcon" in line:
        ...
        try:
            ...
            for tc in data.get("tool_calls", []):
                ...
                if "updateStudentListStatusIcon" in rc:
                    print("Found in ReplacementContent of step:", data.get("step_index"))
                    with open("C:/Users/82102/Desktop/workspace/SRinspector/status_icon_extracted.txt", "w", encoding="utf-8") as f_out:
                        f_out.write(rc)
                    print("Successfully wrote status_icon_extracted.txt!")
                    exit(0)
                cc = args.get("CodeContent", "")
                if "updateStudentListStatusIcon" in cc:
