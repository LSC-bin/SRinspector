...
# 3. Update fetchGeminiAiAnalysis using index finding
...
start_idx = js.find("async function fetchGeminiAiAnalysis")
end_idx = js.find("function escapeHTML(str)")

if start_idx != -1 and end_idx != -1:
    js = js[:start_idx] + fetch_debug + "\n\n" + js[end_idx:]
    print("Replaced fetchGeminiAiAnalysis successfully")
else:
