...
for line in reversed(lines):
    if "subject-list-container" in line:
        ...
        try:
            ...
            for tc in data.get("tool_calls", []):
                ...
                if "subject-list-container" in rc:
                    print("Found in ReplacementContent of step:", data.get("step_index"))
                    with open("C:/Users/82102/Desktop/workspace/SRinspector/subject_view_extracted.txt", "w", encoding="utf-8") as f_out:
                        f_out.write(rc)
                    print("Successfully wrote subject_view_extracted.txt!")
                    exit(0)
                cc = args.get("CodeContent", "")
                if "subject-list-container" in cc:
