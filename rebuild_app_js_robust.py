...
all_marker = js.find("renderEditorStudentList();", all_start)
all_end = js.find("}", all_marker) + 1 if all_marker != -1 else -1
...
with open(app_path, "w", encoding="utf-8") as f:
    f.write(js)
print("Rebuilt app.js with ALL features intact successfully (robustly)")
